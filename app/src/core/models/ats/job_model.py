...
class Job(Base):
    ...
    customer_type: Mapped[str] = Column(
        Enum("Internal", "Vendor", "Prime Vendor", "Direct Client"), nullable=False
    )
    account_id: Mapped[int] = Column(
        Integer, ForeignKey("account.account_id"), nullable=False
    )
    ...
    remote_status: Mapped[str] = Column(
        Enum("On Site", "Remote", "Hybrid"), nullable=False
    )
    ...
    industry_id: Mapped[int] = Column(
        Integer, ForeignKey("industry.industry_id"), nullable=False
    )
    ...
    job_domain_id: Mapped[int] = Column(
        Integer, ForeignKey("job_domains.job_domain_id")
    )
...
class JobRecruiter(Base):
    ...
    job_id: Mapped[int] = Column(
        Integer,
        ForeignKey("job.job_id", ondelete="CASCADE", onupdate="CASCADE"),
        primary_key=True,
    )
...
class JobAdditionalRecruiter(Base):
    ...
    additional_recruiter_id: Mapped[int] = Column(
        Integer,
        ForeignKey("cns_user_def.cu_user_id", ondelete="CASCADE", onupdate="CASCADE"),
        primary_key=True,
    )
...
class JobAccountManager(Base):
    ...
    account_manager_id: Mapped[int] = Column(
        Integer,
        ForeignKey("cns_user_def.cu_user_id", ondelete="CASCADE", onupdate="CASCADE"),
        primary_key=True,
    )
...
class JobRecruitmentManager(Base):
    ...
    recruitment_manager_id: Mapped[int] = Column(
        Integer,
        ForeignKey("cns_user_def.cu_user_id", ondelete="CASCADE", onupdate="CASCADE"),
        primary_key=True,
    )
