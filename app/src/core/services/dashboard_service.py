...
from app.src.core.schemas.responses.dashboard_responses import OverallMetricsModel, MonthlyUploadsModel, \
    RecentCallsModel
...
class DashboardService(BaseService):
    ...
    def get_overall_metrics(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        return [OverallMetricsModel.model_validate(data).model_dump() for data in result]
    ...
    def get_recent_calls(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        for call in recent_calls:
            assigned_to = {'user_id': call.pop('user_id'), 'user_name': call.pop('user_name')}
